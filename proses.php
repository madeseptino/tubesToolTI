<?php
    ...
    if (isset($_POST['submitData'])) {
        ...
        $query = "INSERT INTO tb_customer (id_customer, nama, pekerjaan, alamat) VALUES ('$idC', '$nameC', '$jobC', '$homeC')";
    ...
    if (isset($_POST['submitData'])) {
        if ($_POST['submitData'] == "add") {
            ...
            echo 'Tambah Data <a href="customerTable.php">[Home]</a>';
        } else if ($_POST['submitData'] == "edit") {
            echo 'Edit Data <a href="customerTable.php">[Home]</a>';
            //var_dump($_POST);
            $idC = $_POST['id'];
            $nameC = $_POST['nama'];
            $jobC = $_POST['pekerjaan'];
    ...
    if (isset($_GET['hapus'])) {
        $idC = $_GET['hapus'];
        $query = "DELETE FROM tb_customer WHERE id_customer = '$idCustomer'";
        $sql = mysqli_query($conn, $query);
